 ...
 */
public class TestFrequency extends Mapper<Text, Text, Text, Text> {

	private static final Log log = LogFactory.getLog(TestFrequency.class);
	...
	public static void main(String[] args) throws IOException, JATEException {
		...
		TestFrequencyJob frequencyJob = new TestFrequencyJob();
		try {
			frequencyJob.runFrequencyJob(args[0], args[1]);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
