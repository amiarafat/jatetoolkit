...
/**
 */
public class TestRIDF extends Mapper<Text, Text, Text, Text> {
	...
	public void map(Text key, Text value, Context context) {
		...
		try {
			...
			System.out.println("Started " + TestRIDF.class + "at: "
					+ new Date()
	...
	public static void main(String[] args) throws IOException, JATEException {
		...
		TestRIDFJob ridfJob = new TestRIDFJob();
		try {
			ridfJob.runRIDFJob(args[0], args[1]);
		} catch (Exception e) {
			e.printStackTrace();
		}
